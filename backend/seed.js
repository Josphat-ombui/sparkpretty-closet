...
const products = [
  {
    ...
    variants: [
      ...
      { size: 'S', color: 'Black', colorHex: '#000000', price: 3500, sku: 'SGMD-S-BK', stock: 12, images: [] },
      { size: 'M', color: 'Black', colorHex: '#000000', price: 3500, sku: 'SGMD-M-BK', stock: 18, images: [] },
      { size: 'L', color: 'Black', colorHex: '#000000', price: 3500, sku: 'SGMD-L-BK', stock: 8, images: [] },
    ],
    tags: ['new', 'bestseller'],
  },
  {
    ...
    categorySlug: 'dresses',
    variants: [
      { size: 'S', color: 'Sunset', colorHex: '#FF7043', price: 4200, sku: 'SMD-S-SN', stock: 8, images: [] },
      { size: 'M', color: 'Sunset', colorHex: '#FF7043', price: 4200, sku: 'SMD-M-SN', stock: 12, images: [] },
      { size: 'L', color: 'Sunset', colorHex: '#FF7043', price: 4200, sku: 'SMD-L-SN', stock: 6, images: [] },
    ],
    tags: ['new'],
  },
  {
    ...
    featured: true,
    variants: [
      { size: 'S', color: 'Navy', colorHex: '#1A237E', price: 3200, sku: 'EWD-S-NV', stock: 10, images: [] },
      { size: 'M', color: 'Navy', colorHex: '#1A237E', price: 3200, sku: 'EWD-M-NV', stock: 15, images: [] },
      { size: 'L', color: 'Navy', colorHex: '#1A237E', price: 3200, sku: 'EWD-L-NV', stock: 7, images: [] },
      { size: 'S', color: 'Burgundy', colorHex: '#880E4F', price: 3200, sku: 'EWD-S-BG', stock: 9, images: [] },
      { size: 'M', color: 'Burgundy', colorHex: '#880E4F', price: 3200, sku: 'EWD-M-BG', stock: 14, images: [] },
    ],
    tags: ['bestseller'],
  },
  {
    ...
    categorySlug: 'tops',
    variants: [
      { size: 'XS', color: 'White', colorHex: '#FFFFFF', price: 1800, sku: 'STB-XS-WH', stock: 20, images: [] },
      ...
      { size: 'S', color: 'Blush', colorHex: '#F8BBD0', price: 1800, sku: 'STB-S-BL', stock: 12, images: [] },
      { size: 'M', color: 'Blush', colorHex: '#F8BBD0', price: 1800, sku: 'STB-M-BL', stock: 16, images: [] },
    ],
    tags: ['bestseller'],
  },
  {
    ...
    categorySlug: 'tops',
    variants: [
      { size: 'XS', color: 'Black', colorHex: '#000000', price: 1200, sku: 'CTR-XS-BK', stock: 22, images: [] },
      { size: 'S', color: 'Black', colorHex: '#000000', price: 1200, sku: 'CTR-S-BK', stock: 30, images: [] },
      { size: 'M', color: 'Black', colorHex: '#000000', price: 1200, sku: 'CTR-M-BK', stock: 25, images: [] },
      { size: 'S', color: 'Cream', colorHex: '#FFF8E1', price: 1200, sku: 'CTR-S-CR', stock: 18, images: [] },
    ],
    tags: ['trending'],
  },
  {
    ...
    categorySlug: 'tops',
    variants: [
      { size: 'S', color: 'Camel', colorHex: '#D4A574', price: 2800, sku: 'OKS-S-CM', stock: 14, images: [] },
      { size: 'M', color: 'Camel', colorHex: '#D4A574', price: 2800, sku: 'OKS-M-CM', stock: 18, images: [] },
      { size: 'L', color: 'Camel', colorHex: '#D4A574', price: 2800, sku: 'OKS-L-CM', stock: 10, images: [] },
      { size: 'M', color: 'Oatmeal', colorHex: '#F5F5DC', price: 2800, sku: 'OKS-M-OM', stock: 12, images: [] },
    ],
    tags: [],
  },
  {
    ...
    variants: [
      ...
      { size: 'S', color: 'Black', colorHex: '#000000', price: 2400, sku: 'HWSJ-S-BK', stock: 18, images: [] },
      { size: 'M', color: 'Black', colorHex: '#000000', price: 2400, sku: 'HWSJ-M-BK', stock: 22, images: [] },
      { size: 'L', color: 'Black', colorHex: '#000000', price: 2400, sku: 'HWSJ-L-BK', stock: 12, images: [] },
    ],
    tags: ['bestseller'],
  },
  {
    ...
    categorySlug: 'bottoms',
    variants: [
      { size: 'XS', color: 'Plaid', colorHex: '#795548', price: 1800, sku: 'PMS-XS-PL', stock: 14, images: [] },
      { size: 'S', color: 'Plaid', colorHex: '#795548', price: 1800, sku: 'PMS-S-PL', stock: 18, images: [] },
      { size: 'M', color: 'Plaid', colorHex: '#795548', price: 1800, sku: 'PMS-M-PL', stock: 12, images: [] },
      { size: 'S', color: 'Black', colorHex: '#000000', price: 1800, sku: 'PMS-S-BK', stock: 16, images: [] },
    ],
    tags: ['trending'],
  },
  {
    ...
    categorySlug: 'bottoms',
    variants: [
      { size: 'S', color: 'Beige', colorHex: '#F5F5DC', price: 2600, sku: 'WLT-S-BG', stock: 10, images: [] },
      { size: 'M', color: 'Beige', colorHex: '#F5F5DC', price: 2600, sku: 'WLT-M-BG', stock: 14, images: [] },
      { size: 'L', color: 'Beige', colorHex: '#F5F5DC', price: 2600, sku: 'WLT-L-BG', stock: 8, images: [] },
      { size: 'M', color: 'Black', colorHex: '#000000', price: 2600, sku: 'WLT-M-BK', stock: 20, images: [] },
    ],
    tags: [],
  },
  {
    ...
    categorySlug: 'shoes',
    variants: [
      { size: '36', color: 'Nude', colorHex: '#FFCCBC', price: 2800, sku: 'SHS-36-ND', stock: 8, images: [] },
      { size: '37', color: 'Nude', colorHex: '#FFCCBC', price: 2800, sku: 'SHS-37-ND', stock: 12, images: [] },
      { size: '38', color: 'Nude', colorHex: '#FFCCBC', price: 2800, sku: 'SHS-38-ND', stock: 10, images: [] },
      { size: '39', color: 'Nude', colorHex: '#FFCCBC', price: 2800, sku: 'SHS-39-ND', stock: 6, images: [] },
      { size: '37', color: 'Black', colorHex: '#000000', price: 2800, sku: 'SHS-37-BK', stock: 14, images: [] },
      { size: '38', color: 'Black', colorHex: '#000000', price: 2800, sku: 'SHS-38-BK', stock: 10, images: [] },
    ],
    tags: ['bestseller'],
  },
  {
    ...
    categorySlug: 'shoes',
    variants: [
      { size: '36', color: 'White', colorHex: '#FFFFFF', price: 1800, sku: 'CS-36-WH', stock: 15, images: [] },
      { size: '37', color: 'White', colorHex: '#FFFFFF', price: 1800, sku: 'CS-37-WH', stock: 20, images: [] },
      { size: '38', color: 'White', colorHex: '#FFFFFF', price: 1800, sku: 'CS-38-WH', stock: 18, images: [] },
      { size: '39', color: 'White', colorHex: '#FFFFFF', price: 1800, sku: 'CS-39-WH', stock: 12, images: [] },
      { size: '37', color: 'Pink', colorHex: '#F8BBD0', price: 1800, sku: 'CS-37-PK', stock: 10, images: [] },
    ],
    tags: [],
  },
  {
    ...
    variants: [
      ...
      { size: 'One Size', color: 'Cream', colorHex: '#FFF8E1', price: 2200, sku: 'QCB-OS-CR', stock: 12, images: [] },
    ],
    tags: ['new', 'bestseller'],
  },
  {
    ...
    categorySlug: 'accessories',
    variants: [
      { size: 'One Size', color: 'Gold', colorHex: '#FFD700', price: 850, sku: 'LCN-OS-GD', stock: 30, images: [] },
      { size: 'One Size', color: 'Silver', colorHex: '#C0C0C0', price: 850, sku: 'LCN-OS-SV', stock: 25, images: [] },
    ],
    tags: ['trending'],
  },
  {
    ...
    categorySlug: 'accessories',
    variants: [
      { size: 'One Size', color: 'Floral', colorHex: '#C2185B', price: 1200, sku: 'SS-OS-FL', stock: 18, images: [] },
      { size: 'One Size', color: 'Abstract', colorHex: '#7B1FA2', price: 1200, sku: 'SS-OS-AB', stock: 14, images: [] },
    ],
    tags: [],
  },
  {
    ...
    categorySlug: 'accessories',
    variants: [
      { size: 'One Size', color: 'Black', colorHex: '#000000', price: 1500, sku: 'MBB-OS-BK', stock: 22, images: [] },
      { size: 'One Size', color: 'Khaki', colorHex: '#8D6E63', price: 1500, sku: 'MBB-OS-KH', stock: 16, images: [] },
    ],
    tags: ['new'],
  },
];
